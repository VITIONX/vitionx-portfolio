      ...
      <main className="site">
        <section id="home" className="hero">
          ...
          <div className="hero-visual">
            ...
            <a href="#contact" className="hero-orbit">
              <span>
                HIRE
                <br />
                ME
        ...
        >
          <div className="stat">
            <strong data-target="10">0+</strong>
            <span>Years of Experience</span>
          </div>

          <div className="stat">
            <strong data-target="700">0+</strong>
          ...
          <div className="about-content">
            ...
            <div className="about-details">
              ...
              <p className="about-intro">
                I&apos;m Sakib, a Strategic Brand Designer focused on
                creating memorable, professional and meaningful visual
                identities that help brands stand out.
              </p>

              <p className="about-text">
                With years of experience in graphic and brand design, I
                work across visual identity, marketing communication and
                digital design to build clear and consistent brand
                experiences.
              </p>
            </div>
          </div>
          ...
          <div className="service-grid">
            ...
            <article className="service-card">
              ...
              <div className="service-card-content">
                ...
                <p>
                  Building distinctive brand identities, visual systems
                  and strategic design foundations that create a
            ...
            <article className="service-card">
              ...
              <div className="service-card-content">
                ...
                <p>
                  Creating professional visual communication for
                  marketing, advertising, presentations and promotional
                  materials.
                </p>
              </div>
            ...
            <article className="service-card">
              ...
              <div className="service-card-content">
                ...
                <p>
                  Designing engaging and consistent social media visuals
                  that communicate clearly and strengthen your brand
                  online.
                </p>
              </div>
